...
namespace Traversal_Rezervasyon_Asp.Net_Core_5._0.Controllers
{
    public class ExcelController1 : Controller
    {
        ...
        public ExcelController1(IExcelService excelService)
        {
        ...
        {
            return File(_excelService.ExcelList(DestinationList()), "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","exceldoysa.xlsx");
        }
